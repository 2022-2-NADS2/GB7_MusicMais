...
console.log(userDetails?.Status)
 ...
 //}
  return (
    ...
    <h1>Signup</h1>
          <input class="no_border" type="file" name="file" id="file" onChange={(e)=>setfile(e.target.files[0])} />
          <input type="text" id="email" placeholder='Username' onChange={(e)=>setusername(e.target.value)} className='inputText' />
          ...
          <Link to={"/"}>
          <p style={{textAlign:'start' , marginLeft:"30.6%", fontSize: "13px" }}>Already have a account</p>
          </Link>
          </div>
          </main>
  )
